...
/**
 * atualiza um terminal no
 * registro de terminais
 * @param t o terminal atualizado
 * @param bd o descritor de arquivo do bd
 * @return o código de resultado
 */
gt_resultado gt_bd_atualizar(gt_terminal t, int bd) {
    gt_resultado resultado;
    gt_terminal terminal;
    
    if((resultado = gt_bd_buscar_por_nome(t.nome, &terminal, bd)) == GT_ENCONTRADO) {
